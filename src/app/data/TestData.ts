...
export class TestData {
  ...
  //не забыть - индексацию приоритетов и категорий начинается с нуля
  static tasks: Task[] = [
    {
      id: 1,
    ...
    {
      id: 3,
      title: 'Убрать у себя в комнате, полить растения',
      priority: TestData.priorities[2],
      completed: true,
    ...
    {
      id: 7,
      title: 'Найти билеты в турцыю, выбрать отель',
      priority: TestData.priorities[2],
      completed: false,
